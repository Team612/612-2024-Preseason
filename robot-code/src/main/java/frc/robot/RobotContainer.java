...
public class RobotContainer {
 ...
 // Trajectories
  ...
  //TEST AUTONOMOUS
  private final Command m_driveObject = new SequentialCommandGroup(new TurnTowardsObject(m_drivetrain, m_limelight).andThen(new DriveToObject(m_drivetrain, m_limelight)));
